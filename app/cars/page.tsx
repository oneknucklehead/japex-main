          ...
          <div className="flex items-end justify-between mb-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="lg:hidden flex items-center gap-2 bg-white border border-gray-200 rounded-xl px-3 py-2 shadow-sm text-sm font-semibold text-gray-700"
              >
                <svg
                  className="w-4 h-4"
                  fill="none"
              ...
              {mobileSidebarOpen && (
                <>
                  ...
                  <motion.div
                    ...
                    className="fixed top-0 left-0 h-full w-80 bg-gray-50 z-50 overflow-y-auto lg:hidden"
                  >
