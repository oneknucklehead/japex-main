...
// Trust badge data
const TRUST_BADGES = [
  { icon: "🔍", label: "Examined by experts" },
  { icon: "🛡️", label: "3 months warranty" },
  { icon: "↩️", label: "7 day money back guarantee" },
  { icon: "🚚", label: "Free delivery to your door*" },
];
            ...
            >
              ...
              <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm">
                ...
                <div className="border-t border-gray-100 pt-4 mb-4">
                  ...
                  <div className="flex items-start justify-between mb-1">
                    ...
                    {car.condition === "Excellent" && (
                      <span className="bg-amber-400 text-white text-xs font-bold px-3 py-1.5 rounded-full flex items-center gap-1 shrink-0">
                        <svg
                          className="w-3 h-3"
                          fill="currentColor"
                          viewBox="0 0 20 20"
                ...
                <div className="flex flex-col gap-3">
                  <motion.button
                    whileTap={{ scale: 0.98 }}
                    className="w-full bg-amber-400 hover:bg-amber-500 text-white font-bold py-3.5 rounded-xl transition-colors text-sm"
                  >
                    Get started
                  </motion.button>
                  <motion.button
