    ...
    <div className="relative w-full">
      ...
      <div className="flex justify-end gap-2 mb-4 px-1">
        <motion.button
          ...
          aria-label="Previous"
          className={`w-9 h-9 sm:w-10 sm:h-10 cursor-pointer rounded-xl border border-gray-300 bg-white flex items-center justify-center shadow-sm transition-all duration-200
            ${
              canScrollPrev
        ...
        <motion.button
          ...
          aria-label="Next"
          className={`w-9 h-9 sm:w-10 sm:h-10 rounded-xl border border-gray-300 cursor-pointer bg-white flex items-center justify-center shadow-sm transition-all duration-200
            ${
              canScrollNext
                ? "hover:border-gray-400 hover:shadow-md text-gray-700"
                : "opacity-40 cursor-not-allowed text-gray-400"
        ...
        <div className="flex items-stretch -ml-4">
          {cars.map((car, i) => (
            <motion.div
              ...
              className="flex-none min-w-0 pl-4 w-full sm:w-1/2 md:w-1/3 lg:w-1/4"
            >
